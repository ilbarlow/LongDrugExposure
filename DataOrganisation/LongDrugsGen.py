...
writer = pd.ExcelWriter(os.path.join(os.path.dirname(directoryA), 'LongExposureFeatures5mins.xlsx'))
...
writer = pd.ExcelWriter(os.path.join(os.path.dirname(directoryA), 'LongExposureFeatMatMean5mins.xlsx'))
